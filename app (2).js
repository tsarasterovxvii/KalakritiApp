...
const products = [
    { id: 1, name: "Traditional Rajasthani Pottery Bowl", artisanId: 1, artisanName: "Rajesh Kumar", region: "Rajasthan", price: 2500, icon: "🏺", rating: 4.8, reviews: 45, description: "Handcrafted pottery bowl featuring traditional Rajasthani motifs. Hand-painted with natural pigments.", material: "Clay", dimensions: "12cm x 12cm" },
    { id: 2, name: "Kerala Wooden Wall Sculpture", artisanId: 2, artisanName: "Priya Sharma", region: "Kerala", price: 5800, icon: "🗿", rating: 4.9, reviews: 62, description: "Stunning wooden wall art inspired by Kerala temple architecture. Each piece is unique and hand-carved.", material: "Wood", dimensions: "30cm x 40cm" },
    { id: 3, name: "Gujarat Embroidered Wall Hanging", artisanId: 3, artisanName: "Arjun Singh", region: "Gujarat", price: 3200, icon: "🧵", rating: 4.7, reviews: 38, description: "Vibrant embroidered textile with traditional Gujarat patterns. Sustainably dyed natural fabric.", material: "Textile", dimensions: "60cm x 80cm" },
    { id: 4, name: "Tamil Nadu Brass Decorative Vessel", artisanId: 4, artisanName: "Deepak Nair", region: "Tamil Nadu", price: 4200, icon: "⚱️", rating: 4.9, reviews: 71, description: "Intricately engraved brass vessel with traditional Tamil Nadu designs. Perfect for home decoration.", material: "Brass", dimensions: "20cm height" },
    { id: 5, name: "Odisha Tribal Canvas Art", artisanId: 5, artisanName: "Maya Das", region: "Odisha", price: 2800, icon: "🎨", rating: 4.6, reviews: 29, description: "Authentic tribal art from Odisha featuring traditional patterns and symbolism. Natural materials used.", material: "Canvas & Natural pigments", dimensions: "50cm x 60cm" },
    { id: 6, name: "Handpainted Ceramic Tea Set", artisanId: 1, artisanName: "Rajesh Kumar", region: "Rajasthan", price: 3500, icon: "☕", rating: 4.8, reviews: 34, description: "Beautiful ceramic tea set with traditional patterns. Includes 6 cups and 1 teapot.", material: "Clay", dimensions: "Teapot: 15cm height" },
    { id: 7, name: "Kerala Temple Inspired Statue", artisanId: 2, artisanName: "Priya Sharma", region: "Kerala", price: 7500, icon: "🛕", rating: 4.9, reviews: 56, description: "Hand-carved wooden statue inspired by Kerala temple architecture. Intricate detail work.", material: "Wood", dimensions: "45cm height" },
    { id: 8, name: "Gujarat Colorful Tapestry", artisanId: 3, artisanName: "Arjun Singh", region: "Gujarat", price: 2900, icon: "🎭", rating: 4.7, reviews: 27, description: "Beautifully embroidered tapestry with vibrant colors. Perfect for adding warmth to any room.", material: "Textile", dimensions: "100cm x 120cm" },
    { id: 9, name: "Brass Oil Lamp (Diya)", artisanId: 4, artisanName: "Deepak Nair", region: "Tamil Nadu", price: 1800, icon: "🪔", rating: 4.9, reviews: 89, description: "Traditional brass oil lamp with intricate engravings. Perfect for festivals and home decoration.", material: "Brass", dimensions: "12cm height" },
    { id: 10, name: "Tribal Art Print Series", artisanId: 5, artisanName: "Maya Das", region: "Odisha", price: 1500, icon: "🖼️", rating: 4.6, reviews: 19, description: "Set of 3 tribal art prints on eco-friendly paper. Celebrate indigenous wisdom and culture.", material: "Paper & Natural pigments", dimensions: "A4 size (3 prints)" }
];
    ...
    return `
        <div class="product-card" onclick="showProductDetail(${product.id})">
            ...
            <div class="product-image">
                <span style="font-size: 60px;">${getProductIcon(product)}</span>
            </div>
...
function showProductDetail(productId) {
    ...
    container.innerHTML = `
        <div class="product-detail-image">
            <span style="font-size: 120px;">${getProductIcon(product)}</span>
        </div>
            ...
            ${appState.cart.map(item => `
                <div class="cart-item">
                    <div class="cart-item-image">
                        <span style="font-size: 30px;">${getProductIcon(item.product)}</span>
                    </div>
    ...
    container.innerHTML = artisans.map(artisan => `
        <div class="artisan-card" onclick="showArtisanDetail(${artisan.id})">
            <div class="artisan-header">
                <div class="artisan-profile-pic">👤</div>
...
function showArtisanDetail(artisanId) {
    ...
    container.innerHTML = `
        <div class="artisan-profile-section">
            <div class="artisan-profile-large">👤</div>
            <h2>${artisan.name}</h2>
